/*!Copyright (C) GTranslate Inc.*/ (function () {
    ...
    var flag_size = gt.flag_size || 24;
    var flag_style = gt.flag_style || "3d";
    ...
    var detect_browser_language =  false; // TODO: gt.detect_browser_language || false;
    var wrapper_selector = gt.wrapper_selector || ".gtranslate_wrapper";
    var switcher_text_color = gt.switcher_text_color || "#fff";
    var switcher_arrow_color = gt.switcher_arrow_color || "#fff";
    var switcher_border_color = gt.switcher_border_color || "none";
    var switcher_background_color = gt.switcher_background_color || "transparent";
    var switcher_background_shadow_color =
        gt.switcher_background_shadow_color || "#efefef";
    var switcher_background_hover_color =
        gt.switcher_background_hover_color || "#000";
    var dropdown_text_color = gt.dropdown_text_color || "#fff";
    var dropdown_hover_color = gt.dropdown_hover_color || "#ffffff60";
    var dropdown_background_color = gt.dropdown_background_color || "#000";
    ...
    var font_size = 10,
        ...
        arrow_size = 7;
    if (flag_size == 24)
        (font_size = 14), (widget_width = 173), (arrow_size = 11);
    ...
    widget_css +=
        ...
        font_size +
        "px;text-align:left;cursor:pointer;overflow:hidden;width:" +
        "line-height:0}";
    widget_css +=
        u_class +
        " .gt_switcher a{text-decoration:none;display:block;font-size:" +
        font_size +
        "px;box-sizing:content-box}";
    widget_css +=
        u_class +
        " .gt_switcher a img{width:" +
        flag_size +
        "px;height:" +
        flag_size +
        "px;vertical-align:middle;border:0;padding:0;margin:0;opacity:0.8}";
    widget_css += u_class + " .gt_switcher a:hover img{opacity:1}";
    widget_css +=
        u_class +
        " .gt_switcher .gt_selected{background:" +
        switcher_background_color +
        ";max-width: 119px;" + //TODO:
        // " linear-gradient(180deg, " +
        // switcher_background_shadow_color +
        // " 0%, " +
        // switcher_background_color +" 70%); +
        "position:relative;z-index:9999}";
    //TODO: 
    widget_css += u_class + ` .gt_switcher .gt_selected a div{
        width: 24px;
        height: 24px;
        border-radius: 50%;
        overflow: hidden;
    ...
    widget_css += u_class + ` .gt_switcher .gt_selected a div img{
        object-fit:none
    }`;
    //TODO: 
    ...
    widget_css +=
        u_class +
        " .gt_switcher .gt_selected a{ display:flex; align-items:center;" +
        // border:1px solid " +
        // switcher_border_color +
        "color:" +
        switcher_text_color +
        ";padding:5px 5px;width:" + // TODO:
        (widget_width - 2 * 5 - 2 * 1) +
        "px}";
    // TODO: 
    widget_css +=
        u_class +
        ...
        arrow_size +
        "px;background-image:url(\"data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='8' height='10' viewBox='0 0 285 285'><path d='M282 76.5l-14.2-14.3a9 9 0 0 0-13.1 0L142.5 174.4 30.3 62.2a9 9 0 0 0-13.2 0L3 76.5a9 9 0 0 0 0 13.1l133 133a9 9 0 0 0 13.1 0l133-133a9 9 0 0 0 0-13z' style='fill:" +
    ...
    widget_css +=
        u_class +
        " .gt_switcher .gt_selected a:hover{background:" +
    ...
    widget_css +=
        ...
        ";display:none;width:" +
        (widget_width - 2 * 1) +
        "px;transition:height 0.5s ease-in-out;}"; //TODO: max-height:198px;height:0;box-sizing:content-box;overflow-y:auto;overflow-x:hidden;
    widget_css +=
        u_class +
        " .gt_switcher .gt_option a{color:" +
        dropdown_text_color +
        ";padding:0.5rem 1rem}"; // TODO:
        // TODO:
        widget_css +=
        u_class +
        ` .gt_switcher .gt_option a div{
            border-radius: 50%;
            overflow: hidden;
            width: 25px;
            height: 25px;
        ...
        widget_css +=
        u_class +
        ` .gt_switcher .gt_option a div img{
            object-fit: none;
        }`;
    ...
    widget_css +=
        u_class +
        " .gt_switcher .gt_option a:hover{background:" +
    ...
    languages.forEach(function (lang) {
        ...
        // TODO: 
        el_a.style.display ="flex";
        el_a.style["alignItems"] ="center";
        el_a.style.gap ="10px";
        // TODO:
        lang == current_lang && el_a.classList.add("gt_current");
        el_a.setAttribute("data-gt-lang", lang);
        var el_img = document.createElement("img");
        el_img.height = el_img.width = flag_size; // TODO:
    ...
    if (switcher_horizontal_position != "inline")
        widget_code =
            '<div class="gt_switcher_wrapper" style="position:static;' +  //fixed
    ...
    function gt_show_slider(el) {
        ...
        option_el.style.position = 'fixed'; // TODO: 
        // option_el.style.right = '0';
        option_el.style.display = "block";
        option_el.style.overflowY = "hidden";
        option_el.style.width = "auto";
        option_el.style["border-radius"] = "10px"
        setTimeout(function () {
            if (option_el.style.display != "block") return;
            option_el.style.height = 'auto'
            // Math.min(
            //   198,
            //   Math.min(option_el.childElementCount - 1, 6) * (flag_size + 6) + 1
            // ) + "px";
        }, 100);
        setTimeout(function () {
            if (option_el.style.display != "block") return;
    ...
    function gt_hide_slider() {
        ...
        document
            .querySelectorAll(u_class + " div.gt_switcher")
            .forEach(function (e) {
    ...
    function gt_update_slider_language(el) {
        //TODO:
            ...
            if (el.childNodes[0].tagName == 'IMG') {
                var txt = el.childNodes[1];
                el_div.appendChild(el.childNodes[0]);
                
                el.appendChild(el_div);
                el.appendChild(txt);
            }
        //TODO:
        el.parentNode.parentNode.querySelector("div.gt_selected a").innerHTML = el.innerHTML; //TODO:   
        setTimeout(function () {
    ...
    document
        .querySelectorAll(u_class + " .gt_switcher div.gt_selected")
        .forEach(function (e) {
            ...
            e.addEventListener("pointerenter", function (evt) {
                evt.target.parentNode
                    .querySelectorAll(".gt_option img:not([src])")
    ...
    document
        .querySelectorAll(u_class + " .gt_switcher div.gt_option a")
        .forEach(function (e) {
            e.addEventListener("click", function (evt) {
                if (url_structure == "none") {
                    evt.preventDefault();
    ...
    setTimeout(() => {
        const gTranslate = document.querySelector('.VIpgJd-ZVi9od-aZ2wEe-wOHMyf');
        if (gTranslate) {
            gTranslate.remove();
        }
    }, 1000);
